...
export default function ReferralLandingPage() {
  ...
  if (state === "invalid") {
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center gap-4 bg-base px-4 text-center">
        ...
        <Link
          href="/register"
          className="mt-2 rounded-lg bg-lime px-5 py-2.5 text-sm font-semibold text-black hover:opacity-90"
        >
          Criar conta grátis
        </Link>
      </div>
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-base px-4 py-12">
      <div className="w-full max-w-sm space-y-6 text-center">
        <Logo className="mx-auto" />

        <div className="rounded-card border border-lime/30 bg-lime/5 p-6">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-lime/10">
            <Gift className="h-6 w-6 text-lime" aria-hidden />
          </div>
          <h1 className="font-display text-xl font-semibold">
            Você foi convidado!
          </h1>
        ...
        <div className="grid grid-cols-3 gap-3 text-center text-xs">
          <div className="rounded-lg border border-line bg-surface p-3">
            <CheckCircle2 className="mx-auto mb-1.5 h-4 w-4 text-lime" />
          ...
          <div className="rounded-lg border border-line bg-surface p-3">
            <Users className="mx-auto mb-1.5 h-4 w-4 text-lime" />
        ...
        <div className="space-y-3">
          <Link
            href="/register"
            className="flex w-full items-center justify-center rounded-lg bg-lime px-5 py-3 text-sm font-semibold text-black transition-opacity hover:opacity-90"
          >
            Criar conta grátis
          </Link>
