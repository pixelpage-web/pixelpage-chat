...
/** Cores determinísticas por nome para avatares sem foto (verde reservado
    ao logo/wordmark — paleta aqui não usa lime/ok). */
const palettes = [
  "bg-[#2A3B3B] text-[#7FD9CE]",
  "bg-[#3B2A2E] text-[#F4A0B5]",
  "bg-[#2A323B] text-[#7FC4F4]",
  "bg-[#3B362A] text-amber",
  "bg-[#2F2A3B] text-[#B6A0F4]",
  "bg-[#3B2E2A] text-[#F4B08A]",
];
